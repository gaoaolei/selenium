...
print('p',driver.find_element_by_css_selector('p').text)
print('p',driver.find_elements_by_css_selector('p'))
print('div#food',driver.find_element_by_css_selector('div#food').text)
print('.vegetable',driver.find_element_by_css_selector('.vegetable').text)
print('span.vegetable',driver.find_element_by_css_selector('span.vegetable').text)
print('div .vegetable',driver.find_element_by_css_selector('div .vegetable').text)
print('#many .special',driver.find_element_by_css_selector('#many .special').text)
print('body .cheese span',driver.find_elements_by_css_selector('body .cheese span')[1].text)
print('------------------------a---------------------------------')
